...
GIPS = "/sites/all/modules/gv_utils/gv_timemap/images/"; // Drupal module path
//GIPS = "timemap/images/";
...
function TimeMapTheme(options) {
    ...
    this.eventIconPath =     options.eventIconPath || GIPS;
...
TimeMap.themes = {
     ...
     * custom for GV
     * @param {Object} options  Container for optional settings
     * @return {TimeMapTheme}   Manual theme
     * @see TimeMapTheme
     */
    black: function(options) {
        options = options || {};
        options.iconImage = GIPS + "marker-black.png";
        options.color = "#000000";
        options.eventIconImage = "black-circle.png";
        return new TimeMapTheme(options);
    },
    ...
    grey: function(options) {
        options = options || {};
        options.iconImage = GIPS + "marker-grey.png";
        options.color = "#999999";
        options.eventIconImage = "grey-circle.png";
        return new TimeMapTheme(options);
    }
};
